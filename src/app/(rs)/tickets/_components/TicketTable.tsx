...
import type { TicketSearchType } from "@/services/tickets";
import {
  ArrowDownIcon,
  ArrowUpIcon,
  ArrowUpDownIcon,
...
export const TicketTable = ({ data }: Props) => {
  ...
  const table = useReactTable({
    data,
    columns,
    state: { sorting, columnFilters, pagination: { pageIndex, pageSize: 10 } },
  ...
  }, [router, searchParams, table.getState().columnFilters]); // eslint-disable-line react-hooks/exhaustive-deps
